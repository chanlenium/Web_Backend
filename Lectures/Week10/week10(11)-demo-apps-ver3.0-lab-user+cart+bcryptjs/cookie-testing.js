...
app.get("/", (req,res)=>{
    res.header('Set-Cookie', 'helloworld=Hello World;username=wsong;email=ws@example.com'); // append the 'Set-Cookie' header to the response to set a "helloworld" cookie
